...
const journey = [
  ...
  { year: '2024', label: 'First embedded + IoT builds' },
      ...
      <div className="container px-4">
        <Reveal direction="left" amount={0.5}>
          ...
          <p className="text-[var(--muted)] max-w-xl mb-14 leading-relaxed">
            ...
            and turns into a working system with sensors, servers, and a dashboard somewhere in the middle.
          </p>
        </Reveal>

        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-14 items-start">
          {/* Photo slot — drop a square headshot at /public/headshot.jpg and this
              will render it in place of the placeholder automatically. */}
          <Reveal direction="scale" delay={0.05}>
            <div className="relative aspect-square rounded-[28px] overflow-hidden border border-[var(--border)] bg-[var(--bg-elevated)]">
              <img
                src="/headshot.jpg"
                alt="Karthik Jayan"
              ...
              />
              <div className="hidden absolute inset-0 flex flex-col items-center justify-center gap-3 mono text-[var(--muted)] text-sm">
                <span className="text-5xl font-semibold accent-text">KJ</span>
                <span>headshot.jpg not found</span>
              </div>
            </div>
