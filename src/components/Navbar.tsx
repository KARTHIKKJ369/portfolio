          ...
          >
            <div className="flex flex-col gap-4 pt-4">
              ...
              <div className="flex gap-4 pt-4 border-t border-[var(--border)]">
                <a href="https://github.com/KARTHIKKJ369" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--fg)]" aria-label="GitHub">
                  <Github className="w-5 h-5" />
                </a>
                <a href="https://www.linkedin.com/in/karthik-jayan-8544ba267/" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--fg)]" aria-label="LinkedIn">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="mailto:karthikjayan369@gmail.com" className="text-[var(--muted)] hover:text-[var(--fg)]" aria-label="Email">
                  <Mail className="w-5 h-5" />
                </a>
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--fg)]" aria-label="Resume">
