...
export const heroRoles = ['Embedded Systems Engineer', 'AI Developer', 'Full Stack Developer']
...
export const projects = [
  ...
  },
  {
    ...
    tag: 'AI · Game Dev',
    featured: false,
    problem: 'Classic Snake has one fixed difficulty — it gets boring fast or impossible too soon.',
    solution:
...
export const skillGroups = [
  { title: 'Embedded', items: ['ESP32', 'STM32', 'Arduino', 'Raspberry Pi'], size: 'large' as const },
  { title: 'Programming', items: ['C / C++', 'Python', 'TypeScript / JavaScript', 'Java', 'SQL'], size: 'large' as const },
  { title: 'AI / ML', items: ['TensorFlow', 'PyTorch', 'OpenCV', 'LSTM', 'RAG pipelines', 'Local LLMs (Ollama)'], size: 'wide' as const },
  { title: 'Web', items: ['React', 'Node.js / Express', 'Tailwind', 'FastAPI'], size: 'medium' as const },
  { title: 'Cloud & tooling', items: ['Firebase', 'Supabase', 'MongoDB', 'Docker', 'Git', 'Tailscale'], size: 'medium' as const },
]
...
export const focusAreas = ['Embedded Systems', 'AI', 'Robotics', 'Computer Vision', 'Full Stack', 'Research']
